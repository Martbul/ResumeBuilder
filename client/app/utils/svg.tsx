...
export const EducationHatIcon = (props: SvgProps) => {
   return(
  <svg
    {...props}
    fill="#000000"
...
export const WorkSuitCaseIcon = (props: SvgProps) => {
   return(
        <svg
    {...props}
    fill="#000000"
...
export const SummaryIcon = (props: SvgProps) => {
   return (
      <svg
         {...props} fill="#000000" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
       <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
       <g
         id="SVGRepo_tracerCarrier"
         strokeLinecap="round"
